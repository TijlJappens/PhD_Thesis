...
\supervisor{Prof.~dr Wojciech De Roeck}{KU Leuven}
\president{}{}
\jurymember{Prof.~dr Thomas Van Riet}{KU Leuven}
\jurymember{Prof.~dr Joseph Indekeu}{KU Leuven}
\externaljurymember{}{}
...
\website{https://fys.kuleuven.be/itf} % Leave empty to hide
\email{tijl.jappens@kuleuven.be} % Leave empty to hide

\address{Celestijnenlaan 200D box }
