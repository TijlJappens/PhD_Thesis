...
\begin{definition}[Equivalence of states]\label{def:ConnectedStates}
	...
	\end{align}
	Here $V(t)$ is the time ordered exponential of $K(t)$. It is defined as the solution of the ode $V'(t)=-iK(t)V(t)$ with the initial condition $V(0)=\id$.
\end{definition}
