...
\section{Equivalence of states vs equivalence of gapped interactions}
...
\end{equation}
To get a version of this theorem for interactions, we first need to redefine the $F$-norm to include the smoothness condition. We therefore define
\begin{equation}
	content
\end{equation}
