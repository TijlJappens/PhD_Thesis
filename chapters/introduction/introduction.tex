...
Most of the things we discussed so far where true for general $C^*$-algebras. Because however, we have a quasi-local $C^*$-algebra we have additional structure. For our quasi-local $C^*$-algebra there is a very useful alternative notion to being quasi-equivalent:
