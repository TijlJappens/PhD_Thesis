...
In this section, we will develop some definitions and mathematical tools that are most frequently used in this thesis. They are used to address some of these issues as well as allow us to generalize some of our previously made statements.
\subsection{The quasi-local \texorpdfstring{$C^*$}{C*}-algebra}
...
\end{definition}
\subsection{Equal at infinity}\label{sec:equal-at-infinity}
