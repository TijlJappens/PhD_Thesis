...
\supervisor{Prof.~dr.~W.~De Roeck}{}
\president{Prof.~dr.~The~Chairman}{}
\jurymember{Prof.~dr.~T.~Van Riet}{}
\jurymember{Prof.~dr.~J.~Indekeu}{}
\externaljurymember{Prof.~dr.~C.~Tauber}{Far Away}
\externaljurymember{Prof.~dr.~S.~Cenatiempo}{Far Away}
...
\email{tijl.jappens@kuleuven.be} % Leave empty to hide
